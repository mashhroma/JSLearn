        ...
        <>
            ...
            <main>
                <section className="photos">
                    ...
                    <img src="./img/prod_big.png" alt="MOSCHINO CHEAP AND CHIC" />
                </section>
                <div className="center">
                    <div className="info-block">
                        <section className="info">
                            <header className="info__heading">
                                <h3 className="info__subtitle">WOMEN COLLECTION</h3>
                                <svg width="63" height="4" viewBox="0 0 63 4" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M63 0.786865H0V3.81225H63V0.786865Z" fill="#EF5B70" />
                                </svg>
                                <h2 className="info__title">MOSCHINO CHEAP AND CHIC</h2>
                            </header>
                            <p className="info__text">Compellingly actualize fully researched processes before proactive
                                outsourcing.
                            ...
                            <div className="info__price">$561</div>
                            <form className="info__select" action="#">
                                <ProductSort />
                                <button className="info__button button" type="button">
